...
_wrap_PyNs3LrWpanNetDevice_Send(PyNs3LrWpanNetDevice *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (PyObject_IsInstance(dest, (PyObject*) &PyNs3Address_Type)) {
        ...
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Address, Ipv4Address, Ipv6Address, Mac16Address, Mac64Address), not %s", Py_TYPE(dest)->tp_name);
        return NULL;
    }
...
_wrap_PyNs3LrWpanNetDevice_SendFrom(PyNs3LrWpanNetDevice *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (PyObject_IsInstance(source, (PyObject*) &PyNs3Address_Type)) {
        ...
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Address, Ipv4Address, Ipv6Address, Mac16Address, Mac64Address), not %s", Py_TYPE(source)->tp_name);
        return NULL;
    }
    if (PyObject_IsInstance(dest, (PyObject*) &PyNs3Address_Type)) {
        dest2 = *((PyNs3Address *) dest)->obj;
...
_wrap_PyNs3LrWpanNetDevice_SetAddress(PyNs3LrWpanNetDevice *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (PyObject_IsInstance(address, (PyObject*) &PyNs3Address_Type)) {
        ...
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Address, Ipv4Address, Ipv6Address, Mac16Address, Mac64Address), not %s", Py_TYPE(address)->tp_name);
        return NULL;
    }
