...
static PyMethodDef PyNs3WifiRadioEnergyModelHelper_methods[] = {
    {(char *) "SetRechargedCallback", (PyCFunction) _wrap_PyNs3WifiRadioEnergyModelHelper_SetRechargedCallback, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "Set", (PyCFunction) _wrap_PyNs3WifiRadioEnergyModelHelper_Set, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "SetTxCurrentModel", (PyCFunction) _wrap_PyNs3WifiRadioEnergyModelHelper_SetTxCurrentModel, METH_KEYWORDS|METH_VARARGS, NULL },
...
_wrap_PyNs3WifiRadioEnergyModelPhyListener_NotifyMaybeCcaBusyStart(PyNs3WifiRadioEnergyModelPhyListener *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (PyObject_IsInstance(duration, (PyObject*) &PyNs3Time_Type)) {
        ...
        PyErr_Format(PyExc_TypeError, "parameter must an instance of one of the types (Time, TracedValue), not %s", Py_TYPE(duration)->tp_name);
        return NULL;
    }
...
_wrap_PyNs3WifiRadioEnergyModelPhyListener_NotifyTxStart(PyNs3WifiRadioEnergyModelPhyListener *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char *) "Od", (char **) keywords, &duration, &txPowerDbm)) {
        return NULL;
    }
    if (PyObject_IsInstance(duration, (PyObject*) &PyNs3Time_Type)) {
        duration2 = *((PyNs3Time *) duration)->obj;
    ...
    (helper_class == NULL)? (self->obj->NotifyTxStart(duration2, txPowerDbm)) : (self->obj->ns3::WifiRadioEnergyModelPhyListener::NotifyTxStart(duration2, txPowerDbm));
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
static PyMethodDef PyNs3WifiRadioEnergyModelPhyListener_methods[] = {
    {(char *) "NotifyWakeup", (PyCFunction) _wrap_PyNs3WifiRadioEnergyModelPhyListener_NotifyWakeup, METH_NOARGS, NULL },
    ...
    {(char *) "NotifySleep", (PyCFunction) _wrap_PyNs3WifiRadioEnergyModelPhyListener_NotifySleep, METH_NOARGS, NULL },
    {(char *) "NotifyTxStart", (PyCFunction) _wrap_PyNs3WifiRadioEnergyModelPhyListener_NotifyTxStart, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "SetUpdateTxCurrentCallback", (PyCFunction) _wrap_PyNs3WifiRadioEnergyModelPhyListener_SetUpdateTxCurrentCallback, METH_KEYWORDS|METH_VARARGS, NULL },
...
PyObject *
_wrap_PyNs3WifiTxCurrentModel_DbmToW(PyNs3WifiTxCurrentModel *PYBINDGEN_UNUSED(dummy), PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    double retval;
    double dbm;
    ...
    retval = ns3::WifiTxCurrentModel::DbmToW(dbm);
...
static PyMethodDef PyNs3WifiTxCurrentModel_methods[] = {
    {(char *) "GetTypeId", (PyCFunction) _wrap_PyNs3WifiTxCurrentModel_GetTypeId, METH_NOARGS|METH_STATIC, NULL },
    {(char *) "DbmToW", (PyCFunction) _wrap_PyNs3WifiTxCurrentModel_DbmToW, METH_KEYWORDS|METH_VARARGS|METH_STATIC, NULL },
    {(char *) "CalcTxCurrent", (PyCFunction) _wrap_PyNs3WifiTxCurrentModel_CalcTxCurrent, METH_KEYWORDS|METH_VARARGS, NULL },
...
PyTypeObject PyNs3WifiTxCurrentModel_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "energy.WifiTxCurrentModel",            /* tp_name */
...
PyObject *
_wrap_PyNs3LinearWifiTxCurrentModel_GetVoltage(PyNs3LinearWifiTxCurrentModel *self)
{
    PyObject *py_retval;
    double retval;
    
    retval = self->obj->GetVoltage();
    py_retval = Py_BuildValue((char *) "d", retval);
    return py_retval;
}
...
PyObject *
_wrap_PyNs3LinearWifiTxCurrentModel_GetEta(PyNs3LinearWifiTxCurrentModel *self)
{
    PyObject *py_retval;
    double retval;
    
    retval = self->obj->GetEta();
    py_retval = Py_BuildValue((char *) "d", retval);
    return py_retval;
}
...
PyObject *
_wrap_PyNs3LinearWifiTxCurrentModel_SetIdleCurrent(PyNs3LinearWifiTxCurrentModel *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    double idleCurrent;
    const char *keywords[] = {"idleCurrent", NULL};
    
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char *) "d", (char **) keywords, &idleCurrent)) {
        return NULL;
    }
    self->obj->SetIdleCurrent(idleCurrent);
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
PyObject *
_wrap_PyNs3LinearWifiTxCurrentModel_SetEta(PyNs3LinearWifiTxCurrentModel *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    double eta;
    const char *keywords[] = {"eta", NULL};
    
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char *) "d", (char **) keywords, &eta)) {
        return NULL;
    }
    self->obj->SetEta(eta);
    Py_INCREF(Py_None);
...
PyObject *
_wrap_PyNs3LinearWifiTxCurrentModel_SetVoltage(PyNs3LinearWifiTxCurrentModel *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    double voltage;
...
PyObject *
_wrap_PyNs3LinearWifiTxCurrentModel_GetIdleCurrent(PyNs3LinearWifiTxCurrentModel *self)
{
    PyObject *py_retval;
    double retval;
    
    retval = self->obj->GetIdleCurrent();
    py_retval = Py_BuildValue((char *) "d", retval);
    return py_retval;
}
...
static PyMethodDef PyNs3LinearWifiTxCurrentModel_methods[] = {
    {(char *) "GetVoltage", (PyCFunction) _wrap_PyNs3LinearWifiTxCurrentModel_GetVoltage, METH_NOARGS, NULL },
    {(char *) "GetEta", (PyCFunction) _wrap_PyNs3LinearWifiTxCurrentModel_GetEta, METH_NOARGS, NULL },
    {(char *) "SetIdleCurrent", (PyCFunction) _wrap_PyNs3LinearWifiTxCurrentModel_SetIdleCurrent, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "SetEta", (PyCFunction) _wrap_PyNs3LinearWifiTxCurrentModel_SetEta, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "SetVoltage", (PyCFunction) _wrap_PyNs3LinearWifiTxCurrentModel_SetVoltage, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "GetIdleCurrent", (PyCFunction) _wrap_PyNs3LinearWifiTxCurrentModel_GetIdleCurrent, METH_NOARGS, NULL },
    {(char *) "GetTypeId", (PyCFunction) _wrap_PyNs3LinearWifiTxCurrentModel_GetTypeId, METH_NOARGS|METH_STATIC, NULL },
    {(char *) "CalcTxCurrent", (PyCFunction) _wrap_PyNs3LinearWifiTxCurrentModel_CalcTxCurrent, METH_KEYWORDS|METH_VARARGS, NULL },
...
PyTypeObject PyNs3LinearWifiTxCurrentModel_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "energy.LinearWifiTxCurrentModel",            /* tp_name */
...
PyObject *
_wrap_PyNs3WifiRadioEnergyModel_SetTxCurrentModel(PyNs3WifiRadioEnergyModel *self, PyObject *args, PyObject *kwargs)
{
    PyObject *py_retval;
    PyNs3WifiTxCurrentModel *model;
    ns3::WifiTxCurrentModel *model_ptr;
    const char *keywords[] = {"model", NULL};
    
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char *) "O!", (char **) keywords, &PyNs3WifiTxCurrentModel_Type, &model)) {
        return NULL;
    }
    model_ptr = (model ? model->obj : NULL);
    self->obj->SetTxCurrentModel(ns3::Ptr< ns3::WifiTxCurrentModel  > (model_ptr));
    Py_INCREF(Py_None);
    py_retval = Py_None;
    return py_retval;
}
...
static PyMethodDef PyNs3WifiRadioEnergyModel_methods[] = {
    ...
    {(char *) "SetTxCurrentModel", (PyCFunction) _wrap_PyNs3WifiRadioEnergyModel_SetTxCurrentModel, METH_KEYWORDS|METH_VARARGS, NULL },
    ...
    {(char *) "SetEnergyRechargedCallback", (PyCFunction) _wrap_PyNs3WifiRadioEnergyModel_SetEnergyRechargedCallback, METH_KEYWORDS|METH_VARARGS, NULL },
    {(char *) "GetTotalEnergyConsumption", (PyCFunction) _wrap_PyNs3WifiRadioEnergyModel_GetTotalEnergyConsumption, METH_NOARGS, NULL },
    {(char *) "SetTxCurrentFromModel", (PyCFunction) _wrap_PyNs3WifiRadioEnergyModel_SetTxCurrentFromModel, METH_KEYWORDS|METH_VARARGS, NULL },
    ...
    {(char *) "HandleEnergyRecharged", (PyCFunction) _wrap_PyNs3WifiRadioEnergyModel_HandleEnergyRecharged, METH_NOARGS, NULL },
...
PyTypeObject Pyns3__WifiModeList_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "energy.Ns3__WifiModeList",            /* tp_name */
...
PyTypeObject Pyns3__WifiModeListIter_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "energy.Ns3__WifiModeListIter",            /* tp_name */
