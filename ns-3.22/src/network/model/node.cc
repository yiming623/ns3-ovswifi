                                ...
                                const Address &from, const Address &to, NetDevice::PacketType packetType)
{
  ...
  std::cout << "11 " << device << packet << protocol << &from << &to << packetType << std::endl;
                                   ...
                                   const Address &from)
{
  ...
  std::cout<< "22 " << device << packet << protocol << &from << std::endl;
                         ...
                         const Address &from, const Address &to, NetDevice::PacketType packetType, bool promiscuous)
{
  ...
  std::cout<< "33 " << device << packet << protocol << &from << &to << packetType << promiscuous << std::endl;
