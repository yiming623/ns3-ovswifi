...
def register_types(module):
    ...
    ## sta-wifi-mac.h (module 'wifi'): ns3::StaWifiMac::MacScanType [enumeration]
    module.add_enum('MacScanType', ['NOTSUPPORT', 'ACTIVE', 'PASSIVE'], outer_class=root_module['ns3::StaWifiMac'])
    ## sta-wifi-mac.h (module 'wifi'): ns3::StaWifiMac::ScanningEntry [struct]
    module.add_class('ScanningEntry', outer_class=root_module['ns3::StaWifiMac'])
...
def register_methods(root_module):
    ...
    register_Ns3StaWifiMacScanningEntry_methods(root_module, root_module['ns3::StaWifiMac::ScanningEntry'])
...
def register_Ns3MacRxMiddle_methods(root_module, cls):
    ...
    ## mac-rx-middle.h (module 'wifi'): void ns3::MacRxMiddle::SetForwardSnrCallback(ns3::Callback<void, ns3::Ptr<ns3::Packet>, ns3::WifiMacHeader const*, double, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> callback) [member function]
    cls.add_method('SetForwardSnrCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::Ptr< ns3::Packet >, ns3::WifiMacHeader const *, double, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'callback')])
    ## mac-rx-middle.h (module 'wifi'): void ns3::MacRxMiddle::SnrReceive(ns3::Ptr<ns3::Packet> packet, ns3::WifiMacHeader const * hdr, double rxSnr) [member function]
    cls.add_method('SnrReceive', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::WifiMacHeader const *', 'hdr'), param('double', 'rxSnr')])
    return
...
def register_Ns3MacLow_methods(root_module, cls):
    ...
    cls.add_method('DestroyBlockAckAgreement', 
                   'void', 
                   [param('ns3::Mac48Address', 'originator'), param('uint8_t', 'tid')])
    ## mac-low.h (module 'wifi'): void ns3::MacLow::EnableForwardSnr(bool enable) [member function]
    cls.add_method('EnableForwardSnr', 
                   'void', 
                   [param('bool', 'enable')])
    ...
    cls.add_method('SetSlotTime', 
                   'void', 
                   [param('ns3::Time', 'slotTime')])
    ## mac-low.h (module 'wifi'): void ns3::MacLow::SetSnrRxCallback(ns3::Callback<void, ns3::Ptr<ns3::Packet>, ns3::WifiMacHeader const*, double, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty> callback) [member function]
    cls.add_method('SetSnrRxCallback', 
                   'void', 
                   [param('ns3::Callback< void, ns3::Ptr< ns3::Packet >, ns3::WifiMacHeader const *, double, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty, ns3::empty >', 'callback')])
...
def register_Ns3StaWifiMac_methods(root_module, cls):
    ...
    cls.add_method('GetTypeId', 
                   ...
                   [], 
                   is_static=True)
    ## sta-wifi-mac.h (module 'wifi'): void ns3::StaWifiMac::NotifyCcaBusyOccurred() [member function]
    cls.add_method('NotifyCcaBusyOccurred', 
                   'void', 
                   [])
    ## sta-wifi-mac.h (module 'wifi'): void ns3::StaWifiMac::NotifySwitchingStartNow(ns3::Time duration) [member function]
    cls.add_method('NotifySwitchingStartNow', 
                   'void', 
                   [param('ns3::Time', 'duration')])
    ...
    cls.add_method('SetProbeRequestTimeout', 
                   'void', 
                   [param('ns3::Time', 'timeout')])
    ## sta-wifi-mac.h (module 'wifi'): void ns3::StaWifiMac::SetWifiPhy(ns3::Ptr<ns3::WifiPhy> phy) [member function]
    cls.add_method('SetWifiPhy', 
                   'void', 
                   [param('ns3::Ptr< ns3::WifiPhy >', 'phy')], 
                   is_virtual=True)
    ...
    cls.add_method('StartActiveAssociation', 
                   'void', 
                   [])
    ## sta-wifi-mac.h (module 'wifi'): void ns3::StaWifiMac::DoDispose() [member function]
    cls.add_method('DoDispose', 
                   'void', 
                   [], 
                   visibility='protected', is_virtual=True)
    ...
    cls.add_method('Receive', 
                   ...
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::WifiMacHeader const *', 'hdr')], 
                   visibility='private', is_virtual=True)
    ## sta-wifi-mac.h (module 'wifi'): void ns3::StaWifiMac::SnrReceive(ns3::Ptr<ns3::Packet> packet, ns3::WifiMacHeader const * hdr, double rxSnr) [member function]
    cls.add_method('SnrReceive', 
                   'void', 
                   [param('ns3::Ptr< ns3::Packet >', 'packet'), param('ns3::WifiMacHeader const *', 'hdr'), param('double', 'rxSnr')], 
                   visibility='private', is_virtual=True)
...
def register_Ns3StaWifiMacScanningEntry_methods(root_module, cls):
    ## sta-wifi-mac.h (module 'wifi'): ns3::StaWifiMac::ScanningEntry::ScanningEntry() [constructor]
    cls.add_constructor([])
    ## sta-wifi-mac.h (module 'wifi'): ns3::StaWifiMac::ScanningEntry::ScanningEntry(ns3::StaWifiMac::ScanningEntry const & arg0) [copy constructor]
    cls.add_constructor([param('ns3::StaWifiMac::ScanningEntry const &', 'arg0')])
    ## sta-wifi-mac.h (module 'wifi'): ns3::StaWifiMac::ScanningEntry::bssid [variable]
    cls.add_instance_attribute('bssid', 'ns3::Mac48Address', is_const=False)
    ## sta-wifi-mac.h (module 'wifi'): ns3::StaWifiMac::ScanningEntry::channelNumber [variable]
    cls.add_instance_attribute('channelNumber', 'uint16_t', is_const=False)
    ## sta-wifi-mac.h (module 'wifi'): ns3::StaWifiMac::ScanningEntry::rxSnr [variable]
    cls.add_instance_attribute('rxSnr', 'double', is_const=False)
    ## sta-wifi-mac.h (module 'wifi'): ns3::StaWifiMac::ScanningEntry::ssid [variable]
    cls.add_instance_attribute('ssid', 'ns3::Ssid', is_const=False)
    return
